...
<body>
      ...
      <div class="box backgroundColor-box" id="loginBox" style="display:flex; justify-content:center">
              ...
              <form action="resetpass_code.php" method="post">
                  <input class="input-email" type="text" id="username" name="email" placeholder="example@mail.com" >
                  <button class="reset-button" type="submit" name="password-reset-link-btn">
