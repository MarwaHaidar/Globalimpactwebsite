...
<html>
	...
	<body>
		...
		<main style="margin-top: 35px;" >
			<article id="popular-news" style="width: 100%; margin: 0;">
				<div id="featured">
					<h2 style="background-color: #0099ff;" >AFGHAN LUKE</h2>
			   ...
			   if (isset($_POST['upvotebtn']) || isset($_POST['downvotebtn'])) {
				   ...
				   if ($resultCheckVote->num_rows > 0) {
					   ...
					   try {
						   ...
						   echo '<script>window.location.href = "movies";</script>';
						   exit();
					   }
				   }
			   }
