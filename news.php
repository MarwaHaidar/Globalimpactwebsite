...
<!DOCTYPE html>
    ...
    <body data-page-type="news"> 
        ...
        <section class="news_main"  id="SectionColorModeIdNews">
            <header>
                <a href="./news.php" class="logo">NEWS</a>
                <ul>
                    <li><a href="./userpage.php">Home</a></li>
                    <li><a href="./categories.php" >Sports</a></li>
                    <li><a href="./news.php" class="AcitveCategory">News</a></li>
            ...
            <div class="content">
                <div class="textBox">
                    ...
                    <h2>The power of<br><span>News</span></h2>
                    <p>
                        captured in words
                    </p>
                    <a href="#POSTSNews">View POSTS</a>
                </div>
                  <div class="imgBox">
                    <img src="images/news1.png" alt="" class="news-image">
            ...
            <ul class="thumb">
                <li><img src="images/1.png" onclick="imgSlider('images/1.png'); changeColor('#FFA500');"></li>
                <li><img src="images/4.png" onclick="imgSlider('images/4.png'); changeColor('#2236b4');"></li>
                <li><img src="images/3.png" onclick="imgSlider('images/3.png'); changeColor('#0099ff');"></li>
            </ul> -->
   ...
   <!-- ----------------------------------------------------------------------------------------------------------------------------------- -->
        ...
        <section class="POSTS" id="POSTSNews">
