...
<!DOCTYPE html>
    ...
    <body data-page-type="Technologies">
        <div class="main_content" id="main_content">
            <section class="section">
                <div class="cover" style="box-shadow: 5px 5px 5px black !important; width: 100%;">
        <section class="main-tec"  id="sectionColorModeIdTechnologies">
            <header>
                <a href="./technology.php" class="logo">Tecnology</a>
                <ul>
                <li><a href="userpage.php">Home</a></li>
                <li><a href="categories.php">Sports</a></li>
                <li><a href="news.php">News</a></li>
                <li><a href="technology.php" class="AcitveCategory">Technologies</a></li>
            ...
            <div class="content" style="z-index: 999;">
                <div class="textBox">
                    ...
                    <a href="#POSTSTechnologie">View POSTS</a>
                </div>
                  <div class="imgBox-tech"  >
                    <img src="images/face4.png" alt="" class="tech" >
                </div> 
            </div>
        ...
        <section class="POSTS" id="POSTSTechnologie">
        ...
        <?php
            ...
            if (isset($_POST['upvotebtn']) || isset($_POST['downvotebtn'])) {
                ...
                if ($resultCheckVote->num_rows > 0) {
                    ...
                    try {
                        $stmtupvote->execute();
                        echo '<script>window.location.href = "technology.php";</script>';
                        exit();
                        ...
                        echo '<script>window.location.href = "technology";</script>';
                        exit();
                    }
                }
            }
