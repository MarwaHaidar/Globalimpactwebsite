...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = mysqli_real_escape_string($connection, $json->content);

    // Get the type_id for the given userpost_id
    $selectQuery = "UPDATE textpost SET content = '$content' WHERE userpost_id = '$postId'";
