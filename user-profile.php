...
<body>    
    ...
    <?php
                ...
                INNER JOIN profile ON comment.user_id = profile.user_id";
                    ...
                    // print_r($usersVariableComment);
                        ...
                        $userprofileId=$friendid; // get from session
    ...
    <div class="nav-post-container">
      <section class="POSTS" id="POSTS">  
            ...
            INNER JOIN profile ON userposts.user_id = profile.user_id
            INNER JOIN user ON userposts.user_id = user.user_id
            WHERE userposts.user_id= $friendid
            ORDER BY userposts.created_at DESC";
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var photosPageUrl = 'my-photos-page.html';

    // Navigate to the specified page
    window.location.href = photosPageUrl;
});
});
...
<script>
  ...
  //  function getParameterByName(name, url) {
    ...
    // Get the pub_id parameter from the URL
    //const pubId = getParameterByName('pub_id');

    // Log or perform any action with the pub_id
    //console.log('User pub_id from URL:', pubId);
</script>
<script>
...
<script>
    ...
    photo.addEventListener('click', function() {
        ...
        if (imgPubId !== null && imgPubId !== undefined) {
            window.location.href = 'user-photo-page.php?pub_id=' + imgPubId;
        } else {
