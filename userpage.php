...
<div class="overlayStories" id="overlayStories">
  ...
  <!--create social media posts-->
            ...
            <div class="create_post">
                ...
                <input type="text" class="type_something" placeholder="Type Something">
                </div>
                <div class="post_features">
                    <div class="createpost_icons">
                        ...
                        <i class="fa-solid fa-image" style="color:#0099ff;"></i>
                    </div>    
                        <button class="post_post">Post</button>
                    </div>
...
<!-------------------------------this Form  for view All comment inside Overlay------------------------------------------------------>
    ...
    <div id="view-Comments-Overlay-Id" class="view-Comments-Overlay">
        <div class="view-Comments-Overlay-Form">
            ...
            <input type="text" class="write_comment-overlay" placeholder="Write a comment">
            </div>
    ...
    <div class="right_navbar">
        ...
        <div class="community_bar">
           <a href="communityall.php"> <div class="title"  ><i class="fa-solid fa-people-roof" style="color:#0099ff;" id="ComunityPath"></i>
